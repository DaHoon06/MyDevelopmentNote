    ...
    <div id="sideBar-wrap">
      ...
      <div class="sideBar_list">
        <b-list-group>
          ...
          <b-list-group-item href="#">Item5</b-list-group-item>
        </b-list-group>
      </div>
      ...
      <div class="sideBar_list">
        <b-list-group>
          <b-list-group-item href="#" variant="light">Item6</b-list-group-item>
          ...
          <b-list-group-item href="#">Item10</b-list-group-item>
        </b-list-group>
      </div>
    </div>
  </section>
      ...
      <b-navbar toggleable >
        ...
        <b-collapse id="navbar-toggle-collapse" is-nav>
          <b-navbar-nav class="ml-auto">
            ...
            <b-nav-item href="#" disabled>item3</b-nav-item>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
    </div>
